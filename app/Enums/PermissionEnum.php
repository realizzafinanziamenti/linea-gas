...
enum PermissionEnum: string
{
    case ACCESS_DASHBOARD = 'access-dashboard';
        ...
        // CLIENTI
    case ACCESS_CUSTOMERS = 'access-customers';
    ...
    case DELETE_CUSTOMERS = 'delete-customers';
        ...
        // FORNITORI
    case ACCESS_SUPPLIERS = 'access-suppliers';
    ...
    case DELETE_SUPPLIERS = 'delete-suppliers';
        ...
        // TECNICI
    case ACCESS_TECHNICIANS = 'access-technicians';
    ...
    case ACCESS_CALENDAR = 'access-calendar';
        ...
        // INTERVENTI
    case ACCESS_OPERATIONS = 'access-operations';
    ...
    case DELETE_OPERATIONS = 'delete-operations';
        ...
        // PREVENTIVI
    case ACCESS_QUOTES = 'access-quotes';
    ...
    case DELETE_QUOTES = 'delete-quotes';
        ...
        // RICHIESTE
    case ACCESS_REQUESTS = 'access-requests';
    case VIEW_REQUESTS = 'view-requests';
    case CREATE_REQUESTS = 'create-requests';
    case EDIT_REQUESTS = 'edit-requests';
    case DELETE_REQUESTS = 'delete-requests';

        // CONTRATTI
    case ACCESS_CONTRACTS = 'access-contracts';
    ...
    case DELETE_DOCUMENTS = 'delete-documents';
        ...
        // FATTURAZIONE
    case ACCESS_INVOICES = 'access-invoices';
    ...
    case DELETE_INVOICES = 'delete-invoices';
        ...
        // DDT
    case ACCESS_DELIVERY_NOTES = 'access-delivery-notes';
    ...
    case DELETE_DELIVERY_NOTES = 'delete-delivery-notes';
        ...
        // APPROVVIGIONAMENTO
    case ACCESS_PURCHASE_ORDERS = 'access-purchase-orders';
    ...
    case DELETE_PURCHASE_ORDERS = 'delete-purchase-orders';
        ...
        // NOTE DI CREDITO
    case ACCESS_CREDIT_NOTES = 'access-credit-notes';
    ...
    case DELETE_CREDIT_NOTES = 'delete-credit-notes';
        ...
        // MAGAZZINO
    case ACCESS_PRODUCTS = 'access-products';
    ...
    case DELETE_PRODUCTS = 'delete-products';
        ...
        // PAGAMENTI
    case ACCESS_PAYMENTS = 'access-payments';
